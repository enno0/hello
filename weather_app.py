...
canvas.configure(bg="DarkOrange")
canvas.configure(highlightthickness=7)
canvas.configure(highlightbackground="Coral")
canvas.configure(highlightcolor="Tomato")
